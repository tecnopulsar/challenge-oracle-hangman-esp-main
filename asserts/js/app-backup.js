let ahorcado = {
  ...
  iniciar: function () {
    ...
    const boton_reiniciarJuego = document.querySelector(
    ...
    // boton_iniciarJuego.addEventListener("click", function (evento) {
    ...
    // });
    // boton_reiniciarJuego.addEventListener("click", function (evento) {
